                              ...
                              >
                                <div className="flex items-center justify-center h-16">
                                  {creativesLoading || (hasMissingCreatives && refetchingMissingCreatives) ? (
                                    ...
                                    <div className="flex items-center gap-2 text-gray-400 cursor-pointer hover:text-blue-500 transition-colors duration-200" title="Click to refresh creatives">
...
// import { getCampaignInsights, getCombinedAdAccountInsights } from "@/services/api"
// import { toast } from "sonner"
// import type { ActionValue, DateRange } from "@/types/api"
// import { DashboardHeader } from "@/components/dashboard/DashboardHeader"
// import { Button } from "@/components/ui/button"
// import { LeadMetric } from "../components/LeadMetric"
// import { MetricsGrid } from "@/components/dashboard/MetricsGrid"
...
// import { CAMPAIGN_STATUS, CAMPAIGN_OBJECTIVES } from "@/config/constants"
...
//   // Add a new state variable to track initial page load
...
//       return getCombinedAdAccountInsights(selectedAccount, { from: dateRange.from, to: dateRange.to })
//     },
//     enabled: !!selectedAccount && !!dateRange?.from && !!dateRange?.to,
//     refetchOnWindowFocus: false,
//   })
...
//     }
//   } else {
//     // For subsequent data fetches, don't use the full-screen loader
//     setIsPageLoading(false)
//   }
...
//       if (leadAction) {
//         setLeadCount(Number.parseInt(leadAction.value))
//       } else {
//         setLeadCount(0)
//       }
//     } else {
...
//   // Calculate latest reach and frequency
//   const latestReach = timeSeriesInsights?.length
//     ? Number.parseInt(timeSeriesInsights[timeSeriesInsights.length - 1].reach)
//     : 0

//   const latestFrequency = timeSeriesInsights?.length
//     ? (Number.parseFloat(timeSeriesInsights[timeSeriesInsights.length - 1].frequency) || 0).toFixed(2)
//     : "0"
...
//               {/* Lead Metric (next to dropdown) */}
//               <LeadMetric leadCount={leadCount} isLoading={insightsLoading} />
//             </div>
...
//             <MetricsGrid aggregatedMetrics={aggregatedMetrics} timeSeriesInsights={timeSeriesInsights} />
//             {/* Campaign Filters */}
//             <div className="mt-8 space-y-6">
//               {/* Filter Section */}
//               <div className="flex flex-wrap items-center gap-6">
...
//                           <tr className="bg-teal-50 border-t-2 border-teal-200 font-medium">
//                             <td colSpan={3} className="py-3 px-4 text-teal-800 align-middle h-16">
//                               <div className="flex items-center justify-end font-semibold text-sm">Total:</div>
//                             </td>
//                             <td className="py-3 px-4 text-teal-800 align-middle h-16">
//                               <div className="flex items-center gap-2">
//                                 <DollarSign className="w-4 h-4 text-teal-700" />
...
//             </div>
//             <div className="mt-16 gap-y-12">
//               <ChartsGrid timeSeriesInsights={timeSeriesInsights || []} title="Ad Account Analytics" />
//             </div>
//           </>
//         )}
...
//                 </div>
//               </div>
//               <div className="text-teal-700 dark:text-teal-300 font-medium text-lg">Loading dashboard data...</div>
//               <div className="text-gray-500 dark:text-gray-400 text-sm max-w-xs text-center">
//                 Fetching your campaign insights and performance metrics
//               </div>
//             </div>
//           </div>
//         )}
...
//         {!isPageLoading && initialLoadComplete && (insightsLoading || creativesLoading) && (
...
//               <div className="text-teal-700 dark:text-teal-300 text-sm font-medium">Updating data...</div>
//             </div>
//           </div>
//         )}
//       </div>
