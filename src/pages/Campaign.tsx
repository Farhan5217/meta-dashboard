...
const [cachedTimeSeriesInsights, setCachedTimeSeriesInsights] = useState<any[]>([]);
...
useEffect(() => {
  if (!insightsLoading && combinedInsights) {
    setCachedMetrics(combinedInsights.percentChangeData || {});
    setCachedTimeSeriesInsights(combinedInsights.timeSeriesData || []);
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center max-w-md w-full">
      ...
      <p className="text-gray-600 dark:text-gray-300">
        There is no data available for the selected campaign or time period. Try adjusting your date range.
      </p>
      <button
